...
public class TextBrowser extends Activity {
	...
	private class NetworkThread extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			...
			/*System.out.println("--------------------Do 3 GET------------------------");
			result = connect.doGet("http://pgu.khv.gov.ru/?a=Authorization&category=Snils");*/
			
			System.out.println("--------------------Do 4 GET------------------------");
			result = connect.doGet("https://pgu.khv.gov.ru/saml/module.php/core/khvLogin2.php?ref=&srv=http%3A%2F%2F172.18.205.4%3A7779%2FCore%2Fservices%2F&as=default-sp");
			
			System.out.println("--------------------Do 5 GET------------------------");
			result = connect.doGet("https://esia.gosuslugi.ru/idp/Authn/CommonLogin");
